...
void _excavadora::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
  ...
  glPushMatrix();
  if (activo[0]==1) carroceria.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
  else carroceria.draw(modo, r1, g1, b1, r2, g2, b2, grosor);

  glRotatef(giro_cabina,0,1,0);
  glPushMatrix();
  glTranslatef(0.0,(carroceria.altura+cabina.altura)/4.0,0.0);
  if (activo[1]==1) cabina.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
  ...
  glPushMatrix();
  if (activo[2]==1) brazo_base.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
  else brazo_base.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
  ...
  glPushMatrix();
  if (activo[3]==1) brazo_final.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
  else brazo_final.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
  ...
  if (activo[4]==1) gancho_mano.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
  else gancho_mano.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
  glPopMatrix();
...
void _excavadora::seleccion(){
  ...
  c=color_selec[0][0];
  glPushMatrix();
  carroceria.draw(SELECT, c, c, c, c, c, c, 1);
  ...
  glRotatef(giro_brazo_base,0,0,1);
  glPushMatrix();
  brazo_base.draw(SELECT, c, c, c, c, c, c, 1);
  glPopMatrix();
  ...
  glRotatef(giro_brazo_final,0,0,1);
  glPushMatrix();
  brazo_final.draw(SELECT, c, c, c, c, c, c, 1);
  glPopMatrix();
  ...
  glTranslatef((cabina.anchura+brazo_base.altura+brazo_final.altura)/3.5,(carroceria.altura+cabina.altura)/200.0,0.0);
  glRotatef(giro_mano,0,0,1);
  gancho_mano.draw(SELECT, c, c, c, c, c, c, 1);
  glPopMatrix();
  glPopMatrix();
